...
<head>
  ...
  <link rel="stylesheet" href="{{asset('backend/dist/css/bootstrap-toggle.css')}}">
...
<script src="{{asset('backend/dist/js/bootstrap-toggle.js')}}"></script>
